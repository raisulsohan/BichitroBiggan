	...
	return array(
		...
		'footer' => array(
			...
			'fields' => array(
				...
				'bb_about_title'          => array( 'type' => 'text', 'label' => __( 'ABOUT US Heading', 'bichitro-biggan' ), 'default' => 'আমাদের কথা' ),
				...
				'bb_contact_title'        => array( 'type' => 'text', 'label' => __( 'CONTACT US Heading', 'bichitro-biggan' ), 'default' => 'যোগাযোগ' ),
				'bb_subscribe_title'      => array( 'type' => 'text', 'label' => __( 'SUBSCRIBE US Heading', 'bichitro-biggan' ), 'default' => 'সাবস্ক্রাইব করুন' ),
