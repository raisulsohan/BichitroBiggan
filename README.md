...
[![Version](https://img.shields.io/badge/Version-7.19.1-0080ff.svg)](style.css)
...
- 📊 **Own Statistics:** Dashboard → Statistics. Opens on the last 24 hours, hour by hour: reads right now, the figures against the period before, the most-read articles with their Bengali and English tallies, where readers came from, what they read on, when in the day they read, and what they searched for — counted by the site itself, in its own table, with no third-party account and nothing stored that identifies a reader.
